...
contract Crowdsale is Ownable, Pausable {
  ...
  function addIssuer(address _address) public onlyOwner notFinalised {
  ...
  public notFinalised onlyIssuer whenNotPaused {
    require(amount > 0);
  ...
  function finalise() public onlyOwner whenNotPaused {
    require(block.number > startBlock);
    require(!finalised);
  ...
  function drainToken(address _token, address _to) public onlyOwner {
