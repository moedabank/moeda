...
contract MoedaToken is StandardToken, Ownable, HasNoTokens {
  ...
  function create(address recipient, uint256 amount) public onlyOwner canMint {
    require(amount > 0);
  ...
  function createBonusTokens() onlyOwner {
    ...
    create(0x55B30722d84ca292E4432f644F183D1986D2B8F9, 48600000000000000000);
    create(0x7AB6C31747049BBe34a19253c0abe5001cCBe8c6, 2381400000000000000000);
    create(0xF851ff5037212C716e91CD474252B86faCa7bb11, 1437635968200000000000);
    create(0x27ed1A21a243C8CdE077e64014E9E438D8D21482, 72900000000000000000);
    create(0x1697c3c6b4359124C1b2A8fB85114c67B6491965, 486000000000000000000);
    create(0x413864b3Fbc9a59a73205C85C1d69be0220a8D6f, 486000000000000000000);
    create(0x008f2e1AD8ED95040D64Ab9e8D8f3eef7e4e991A, 1458000000000000000000);
    create(0xe96c7892f11304b9d04a96d6FF6edF9B573b2093, 153418744980000000000);
    create(0xc44CA6Ec87A229F61f9C8d4fEBa81dcF51a666dD, 486000000000000000);
    create(0x4e1997a0728bB99ab63e1a39957EE8D9349b0798, 97200000000000000000);
    create(0x88Ad1eA01e9635EcaDCFF10A19C05d1B1cbe90B9, 486000000000000000000);
    create(0x7cB57B5A97eAbe94205C07890BE4c1aD31E486A8, 486000000000000000);
    create(0x3aEd77b7F19f7e0953D4c64a7859699145dbBCCE, 196830000000000000000);
    create(0x22021bB4404A637Cc82CBff53bd30f9c16083095, 97200000000000000000);
    create(0x001D8D7dd820e22cE63E6D86D4A48346BA13C154, 486000000000000000000);
    create(0x3E8A92020d6EF10412b93E52220C68d8f0548a9C, 486000000000000000000);
    create(0x5043732862627D7b00648D385637A46ff02d41f2, 486000000000000000000);
    create(0xDa33a97A4fAc818d250832D9708cAE99a487222d, 972000000000000000000);
    create(0xfE78Be20FeeE8f6d1F64b4731d16ca046A1F625c, 121500000000000000000);
    create(0x9cF947C47fB8E83006233d6b5f1d7F0e8cEDaacc, 1458000000000000000000);
    create(0x9f15F58C4161C5Cf0C1B8139a642e108e8eF2C29, 24300000000000000000);
    create(0x19006Ef9a48f9EA094cCcBA94559266D48FEfF06, 972000000000000000000);
    create(0xC48A6de82842B531DA08b27ca3CF7A95AbD21b37, 12150000000000000000000);
    create(0x00f6be63D0847351A891cD43750c245743308D75, 972000000000000000);
    create(0xdD1240c4A131cB0B037Ac45FfB43b7499f2B164d, 243000000000000000000);
    create(0xc5C456aF2844F610F61e996B83Ec0eD98faa092D, 972000000000000000000);
    create(0x949D6642066DEC1C937aAca4Ec3C2c04Fcc0C2AA, 654485994000000000000);
    create(0xf15E59eccD96E7fC7421ecdf36C100273007E654, 1939140000000000000000);
    create(0x444F63f3661919cE69cfCE67a2f8BAc5A170cadD, 486000000000000000000);
    create(0xd45546Cbc3C4dE75CC2B1f324d621A7753f25bB3, 97200000000000000000);
    create(0xeb3C4E9706064e66358b8c17C351c110Be34F9C7, 486000000000000000000);
    create(0xfC9455179760fEE65B1F82162ebD96cbb626e1b6, 486000000000000000000);
    create(0xE94aE3d286F693A313c7C8A0907c2f425ADb80C9, 40997380500000000000);
    create(0xAc3949c90Aca5e543114b242917426eF78dae650, 36336470400000000000);
    create(0x6541875114bEca413d016fb60B2Aa25e14604d20, 59194800000000000000000);
  }
}
